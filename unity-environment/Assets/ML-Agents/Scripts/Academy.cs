...
namespace MLAgents
{
    ...
    public abstract class Academy : MonoBehaviour
    {
        ...
        private int ReadArgs()
        {
            ...
            base_work_id = int.Parse(inputPort) - 5005;
            isWorkerIDSet = true;
        ...
        /// </summary>
        [HideInInspector] public int base_work_id = 0;
        [HideInInspector] public bool isWorkerIDSet = false;
        [HideInInspector] public MLAgents.Communicator communicator;
